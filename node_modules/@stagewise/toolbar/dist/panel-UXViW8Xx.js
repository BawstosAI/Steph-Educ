import { l as l$1, x as x$2, _ as _$1, k as k$2, H as H$1, J as J$1, b, K as K$1, E as E$1, G as G$1, u as u$1 } from "./jsx-runtime-BDYu3_Il.js";
...
function VSCodeProvider({ children }) {
  const [windows, setWindows] = d([]), [isDiscovering, setIsDiscovering] = d(!1), [discoveryError, setDiscoveryError] = d(null), [selectedSessionId, setSelectedSessionId] = d(void 0), discover = async () => {
    setIsDiscovering(!0), setDiscoveryError(null);
    try {
      const discoveredWindows = await discoverVSCodeWindows();
      setWindows(discoveredWindows), selectedSessionId && !discoveredWindows.some((w2) => w2.sessionId === selectedSessionId) && setSelectedSessionId(void 0);
    } catch (err) {
      setDiscoveryError(
  ...
  const selectedSession = selectedSessionId ? windows.find((w2) => w2.sessionId === selectedSessionId) : void 0, value = {
    windows,
    isDiscovering,
    discoveryError,
    selectedSession,
