...
const ChatContext = K$1({
  ...
  const [chats, setChats] = d$1([
    ...
    setPromptState("idle");
  }, []), { minimized } = useAppState(), { selectedSession } = useVSCode();
  y$1(() => {
...
function ToolbarChatArea() {
  const chatState = useChatState(), [isComposing, setIsComposing] = d$1(!1), currentChat = T(
  ...
  }, [currentChat, currentInput, chatState.addMessage]), handleKeyDown = q(
    (e2) => {
...
const Logo = ({
  ...
  const {
    ...
    const selectedSessionId = e2.target.value || void 0;
  ...
  return /* @__PURE__ */ u$3("div", { className: "space-y-4 pb-4", children: [
    /* @__PURE__ */ u$3("div", { children: [
      ...
      !isDiscovering && windows.length === 0 && !discoveryError && /* @__PURE__ */ u$3("p", { className: "mt-1 text-sm text-zinc-500", children: "No VS Code windows found. Make sure the Stagewise extension is installed and running." })
    ] }),
    ...
    !selectedSession && /* @__PURE__ */ u$3("div", { children: /* @__PURE__ */ u$3("p", { className: "text-sm text-zinc-600", children: [
...
function ToolbarDraggableBox() {
  ...
  }), { windows, isDiscovering, discoveryError, discover } = useVSCode(), isConnected = windows.length > 0, [pluginBox, setPluginBox] = d$1(null), [openPanel, setOpenPanel] = d$1(null), chatState = useChatState(), { minimized, minimize, expand } = useAppState();
  y$1(() => {
  ...
  const isLoadingState = isDiscovering, isDisconnectedState = !isConnected && !isDiscovering, isConnectedState = isConnected, theme = isLoadingState ? {
